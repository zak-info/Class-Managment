...
import {resetStyles} from 'react-style-reset';
...
import img1 from "./images/naho2.jpeg"
import img_1 from "./images/blog/img-1.png"
import img_2 from "./images/blog/img-2.png"
import img_3 from "./images/blog/img-3.png"
import img2 from "./images/saref2.jpg"
import img3 from "./images/bala3a.jpg"
import img4 from "./images/bayan.webp"
...
// const cleanedHtml = ReactHtmlParser(htmlDocument, {
//   transform: (node) => {
//     if (node.type === 'tag' && node.name === 'link') {
//       return null; // Removes all <link> tags
//     }
//     return node;
//   }
// });
        ...
        <div className="container-fluid custom-container">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div className="ms-auto ps-2 ps-lg-0">
                    {/* <a className="btn btn-dark rounded-pill my-3 my-lg-0" ><Link  to="/login" className="btn btn-dark rounded-pill my-3 my-lg-0"  replace style={{textDecoration:"none",color:"white"}}>Login</Link></a> */}
                    <Link  to="/login" className="btn btn-dark rounded-pill my-3 my-lg-0"  replace style={{textDecoration:"none",color:"white"}}>Login</Link>
                </div>
            </div>
        </div>
    </nav>
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="content-item">
                                        <h5 className="text-warning fw-semibold mb-0"  style={{fontFamily: 'Droid Arabic Kufi,sans-serif',color:"#2fb4ae"}}>!!مرحبا</h5>
                                        <div className="home-title mb-0 fw-bold h1">
                                            <span className="typewrite " data-period="2000"
                                                data-type='[ ".موقع الخبير في  اللغة العربية" ]' style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>
                                                <span className="wrap text-dark" style={{fontFamily: 'Tajawal,sans-serif'}}></span>
                                            </span>
                                        </div>
                                        <p className="mt-3 text-muted" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>موقع الخبير في  اللغة العربية</p>
            ...
            <div className="row justify-content-center">
                <div className="col-lg-6">
                    <div className="text-center mb-5">
                        <h6 className="mb-0 text-muted fs-15 text-uppercase"   style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>محتوانا</h6>
                        <h2 style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>المحتوا السنوي </h2>
            ...
            <div className="swiper-container py-5">
                ...
                {arts.map((art,index) => (
                    <div className="swiper-slide  "  key={index}>
                        ...
                        <div className="user-info text-center">
                            <div className="user-info">
                                <h5 className="text-black mb-0"  style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>{art.art}</h5>
                                <p className="mb-0 text-muted fs-14"  style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>{art.des}</p>
                            </div>
                        </div>
                    </div>
                ))}
                    ...
                    {/* <div className="swiper-slide border-radius position-relative ">
                        ...
                        <div className="user-info text-center">
                            <div className="user-info">
                                <h5 className="text-black mb-0"  style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>فن البلاغة</h5>
                                <p className="mb-0 text-muted fs-14" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>نقدم هنا دروس الصرف و ما يتضمنه من معارف و شروحات لكتب متفرقة</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="swiper-slide border-radius position-relative ">
                        <div className="user-image">
                            <img src={img4} alt="" className="avatar-md rounded-circle"/>
                        </div>
                        <div className="text-center mt-4">
                        ...
                        <div className="user-info text-center">
                            <div className="user-info">
                                <h5 className="text-black mb-0" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>فن البيان </h5>
                                <p className="mb-0 text-muted fs-14" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>نقدم هنا دروس البيان و ما يتضمنه من معارف و شروحات لكتب متفرقة</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="swiper-slide border-radius position-relative  ">
                        ...
                        <div className="user-info text-center">
                            <div className="user-info">
                                <h5 className="text-black mb-0" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>فن الصرف 
                                </h5>
                                <p className="mb-0 text-muted fs-14" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>نقدم هنا دروس الصرف و ما يتضمنه من معارف و شروحات لكتب متفرقة</p>
                            </div>
                        </div>
    ...
    <section className="section testimonial" id="testi">
        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-lg-6">
                    <div className="text-center mb-5">
                        <h6 className="mb-0 text-muted fs-15 text-uppercase" style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>الاخبار و التظاهرات</h6>
                        <h2 style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>الاخبار</h2>
            ...
            <div className="swiper-container py-5">
                <div className="swiper-wrapper pt-3">
                    ...
                    <div className="swiper-slide "  key={index}>
                        ...
                        <div className="blog-content mt-5">
                             <p className="text-muted fw-semibold mb-2">{event.date}</p> 
                            <a href="" ><h5>{event.title}</h5></a>
                            <p className="fs-15 text-muted">{event.des}</p>
                            <a href="" className="text-dark fw-semibold">Learn more <i
                                    className="mdi mdi-arrow-right fs-16"></i></a>
                        </div>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-5">
                        <div className="contact-info">
                            <div className="mb-4">
                                <h3  style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>تواصلوا معنا</h3>
                            ...
                            <div className="info-content mt-4">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="icon-content ms-3">
                                        <p className="mb-0 fs-15"  style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}}>متوسطة المجاهد سحوان بن عزوز<br/>
                                            امجدل-المسيلة</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-7 ">
                        <div className="custom-form mt-4 ">
                            <p style={{fontFamily: 'Droid Arabic Kufi,sans-serif'}} >الاستاذ علا الدين مقروف</p>
